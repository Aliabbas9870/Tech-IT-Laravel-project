...
@section('content')
    <div class="container-fluid">
        <div class="row bg-info-50%">
            <main class="col-md-9 ms-sm-auto col-lg-9 px-md-4">
                <div
                    class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2 p-3 mt-5">Dashboard</h1>
                </div>
                        ...
                        <div class="card border-left-danger shadow h-100 py-2 bg-gradient-danger">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-dark mb-1">Admins</div>
                                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $TotalAdmins }}</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-primary shadow h-100 py-2 bg-gradient-primary">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-dark mb-1">Projects</div>
                                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $TotalProject }}</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-info shadow h-100 py-2 bg-gradient-info">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-dark mb-1">Newsletter Subscriptions</div>
                                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $TotalSubscribe }}</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-secondary shadow h-100 py-2 bg-gradient-secondary">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-dark mb-1">Team Members</div>
                                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $TotalAdmins }}</div>
                                    </div>
                                    <div class="col-auto">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-success shadow h-100 py-2 bg-gradient-success">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-dark mb-1">FAQs</div>
                                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $TotalFAQs }}</div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-warning shadow h-100 py-2 bg-gradient-warning">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-dark mb-1">Contacts</div>
                                        <div class="h5 mb-0 font-weight-bold text-dark">{{ $ToatalContact }}</div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-newspaper fa-2x text-gray-300"></i>
                                    </div>
                    ...
                    {{-- <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-dark shadow h-100 py-2 bg-gradient-dark">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-dark mb-1">Company Stack</div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card border-left-light shadow h-100 py-2 bg-gradient-danger">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-black mb-1">Users</div>
                                        <div class="h5 mb-0 font-weight-bold text-black">4</div>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-4 text-center small">
                                    ...
                                    <span class="mr-2">
                                        <i class="fas fa-circle text-dark"></i> Newsletter Subscriptions
                                    </span>
                                </div>
                            </div>
                        </div>
