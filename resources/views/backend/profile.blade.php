                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">Ali Abbas</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Company</div>
                                        <div class="col-lg-9 col-md-8">CU</div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">59/5l Sahiwal</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Phone</div>
                                        <div class="col-lg-9 col-md-8">+92325 1806654 </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Email</div>
                                        <div class="col-lg-9 col-md-8">aliabbas@gmail.com</div>
                                    </div>
                                    ...
                                    <form>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <img src="backend/img/profile-img.jpg" alt="Profile">
                                                <div class="pt-2">
