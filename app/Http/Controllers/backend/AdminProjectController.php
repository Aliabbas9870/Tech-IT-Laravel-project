...
class AdminProjectController extends Controller
{
    ...
    {
        return view('backend.project', ['projects' => Projects::all()]);
    }

    public function projects()
    {
        return view('backend.projects', ['projects' => Projects::all()]);
    }
    public function addProject()
    {
        return view('backend.projectadd');
    }
    ...
    public function submitProjectRecord(Request $request)
    {
        ...
        $PROJECT_STATUS = 1;
        $ImageName = 'Tech_project_' . time() . '.' . $request->image->extension();
    ...
    public function editProject($id)
    {
        ...
        return view('backend.projectedit', ['projects' => $projects]);
