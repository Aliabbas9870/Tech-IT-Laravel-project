...
@endsection
 ...
 @section('main-container')
     ...
     <div class="breadcrumb-area bg-cover shadow dark text-center text-light"
         style="background-image: url('{{ asset('frontend/img/banner/10.jpg') }}');">
         <div class="breadcrum-shape">
             <img src="{{ asset('frontend/img/shape/50.png') }}" alt="Image Not Found">
         </div>
         <div class="container">
             <div class="row">
                 <div class="col-lg-12 col-md-12">
                     ...
                     <div class="magnific-mix-gallery gallery-masonary">
                         <div id="gallery-masonary" class="gallery-items colums-2">
                             ...
                             @foreach ($projects as $project)
                                 <div class="gallery-item">
                                     <div class="gallery-style-two">
                                         <img src="/backend/images/projects/{{ $project->image }}" alt="Thumb">
                                         <div class="shape">
                                             {{-- <img src="/backend/images/projects/{{ $project->hover_image }}" alt="Image Not Found"> --}}
                                         </div>
                                         <div class="overlay">
                                             <div class="content">
                                                 <span>Consulting, Recruitment {{ $project->title }}</span>
                                                 <h4><a href="#">{{ $project->category }}</a></h4>
                                             </div>
                                         </div>
                                     </div>
                                 </div>
