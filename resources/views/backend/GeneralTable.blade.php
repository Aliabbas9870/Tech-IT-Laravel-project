        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Register User Table</h5>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Contact User Table</h5>
                            ...
                            <table class="table table-dark">
                                ...
                                <tbody>
                                    @foreach ($AdminContactModel as $register)
                                        <tr>
                                            <th scope="row">{{ $register->id }}</th>
                                            <td>{{ $register->name }}</td>
                                            <td>{{ $register->email }}</td>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Use contextual classes <code>.table-primary .table-secondary .table-success .table-danger
                                    .table-warning .table-info .table-light .table-dark</code> to color tables, table
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p><a href="https://getbootstrap.com/docs/5.0/utilities/borders/#border-color"
                                    target="_blank">Border color utilities</a> can be added to change colors:</p>
