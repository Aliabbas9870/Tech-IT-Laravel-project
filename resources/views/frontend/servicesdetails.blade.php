...
@section('main-container')
    ...
    ============================================= -->
    <div class="servicesdetails-area overflow-hidden default-padding">
        <div class="container">
            <div class="servicesdetails-items">
                <div class="row">

                    <div class="col-xl-8 col-lg-7 order-lg-last pl-50 pl-md-15 pl-xs-15">
                        <div class="thumb">
                            <img src="frontend/img/banner/12.jpg" alt="Thumb">
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-5 mt-md-120 mt-xs-50 services-sidebar">
                        ...
                        <!-- End Single Widget -->
                        <div class="single-widget bg-dark quick-contact-widget text-light" style="background-image: url(frontend/img/shape/15.png);">
                            <div class="content">
                                <h3>Need Help?</h3>
                                <p>
                                ...
                                <a class="btn mt-30 circle btn-sm btn-gradient" href="#">Contact Us</a>
                            </div>
                        </div>
                        <!-- Single Widget -->
